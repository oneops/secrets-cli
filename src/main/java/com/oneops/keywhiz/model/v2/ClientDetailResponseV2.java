...
import com.oneops.keywhiz.model.ApiDate;
import com.oneops.keywhiz.model.Client;
...
public abstract class ClientDetailResponseV2 {
    ...
    @JsonCreator
    public static ClientDetailResponseV2 fromParts(
        ...
        return new AutoValue_ClientDetailResponseV2(name,
                description,
                createdAtSeconds,
                updatedAtSeconds,
                createdBy,
                updatedBy, lastSeenSeconds);
    }
    ...
    @JsonProperty("lastSeenSeconds")
    public abstract Optional<Long> lastSeenSeconds();
}
