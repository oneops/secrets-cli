package com.oneops.keywhiz.model.v2;
 ...
 */
@AutoValue
public abstract class PartialUpdateSecretRequestV2 {
    ...
    @JsonProperty("contentPresent")
    public abstract boolean contentPresent();

    @JsonProperty("content")
    public abstract String content();

    @JsonProperty("descriptionPresent")
    public abstract boolean descriptionPresent();

    @JsonProperty("description")
    public abstract String description();

    @JsonProperty("metadataPresent")
    public abstract boolean metadataPresent();

    @JsonProperty("metadata")
    public abstract ImmutableMap<String, String> metadata();

    @JsonProperty("expiryPresent")
    public abstract boolean expiryPresent();

    @JsonProperty("expiry")
    public abstract Long expiry();

    @JsonProperty("typePresent")
    public abstract boolean typePresent();
