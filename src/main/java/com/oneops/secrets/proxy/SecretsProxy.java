...
public interface SecretsProxy {
  ...
  Call<Void> createSecret(
      @Path("group") String group,
      @Path("name") String name,
      @Query("createGroup") boolean createGroup,
      @Body SecretReq secretReq);

  @PUT(prefix + "/{group}/secrets/{name}")
  Call<Void> updateSecret(
      @Path("group") String group, @Path("name") String name, @Body SecretReq secretReq);
  ...
  Call<Void> setSecretVersion(
      @Path("group") String group, @Path("name") String name, @Body SecretVersion secretVersion);
